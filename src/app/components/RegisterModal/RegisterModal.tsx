                ...
                >
                    <form onSubmit={handleSubmit}>
                        <Input
                            ...
                            classNameDiv="mb-2"
                            placeholder={
                                dictionary.modal.register.firstnamePlaceholder
                            }
                            textLabel={dictionary.modal.register.firstnameLabel}
                        ...
                        <Input
                            ...
                            classNameDiv="mb-2"
                            placeholder={
                                dictionary.modal.register.lastnamePlaceholder
                            }
                            textLabel={dictionary.modal.register.lastnameLabel}
